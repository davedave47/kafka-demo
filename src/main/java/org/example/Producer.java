...
public class Producer {
    ...
    Air parseAir(String[] values) {
        try {
            ...
            int light = isValid(values[4]) ? Integer.parseInt(values[4]) : Integer.MIN_VALUE;
            float total_rainfall = isValid(values[5]) ? Float.parseFloat(values[5]) : Float.NaN;
            int rainfall = isValid(values[6]) ? Integer.parseInt(values[6]) : Integer.MIN_VALUE;
            int wind_direction = isValid(values[7]) ? Integer.parseInt(values[7]) : Integer.MIN_VALUE;;
            ...
            int co = isValid(values[10]) ? Integer.parseInt(values[10]) : Integer.MIN_VALUE;;
            int nox = isValid(values[11]) ? Integer.parseInt(values[11]) : Integer.MIN_VALUE;;
            int so2 = isValid(values[12]) ? Integer.parseInt(values[12]) : Integer.MIN_VALUE;;
    ...
    Earth parseEarth(String[] values) {
        try {
            ...
            float salinity = isValid(values[5]) ? Float.parseFloat(values[5]) : Float.NaN;
            int water_root = isValid(values[6]) ? Integer.parseInt(values[6]) : Integer.MIN_VALUE;;
            int water_leaf = isValid(values[7]) ? Integer.parseInt(values[7]) : Integer.MIN_VALUE;;
            int water_level = isValid(values[8]) ? Integer.parseInt(values[8]) : Integer.MIN_VALUE;;
